...
required_fields = {"name", "collaborative", "pid", "modified_at", "num_albums", "num_tracks", "num_followers",
                   "num_tracks", "num_edits", "duration_ms", "num_artists", "tracks"}
optional_fields = {"description"}

required_track_fields = {"pos", "artist_name", "artist_uri", "album_uri", "album_name", "track_uri", "track_name",
                         "duration_ms"}
